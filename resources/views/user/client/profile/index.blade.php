                ...
                <div class="col-9">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            <form class="validate-form mt-2 pt-50" method="POST" id="profileImgForm"
                                action="{{route('client.profile.img')}}" enctype="multipart/form-data">
                                @csrf
                                <!-- header section -->
                                <div class="d-flex">
                                    <a href="#" class="me-25">
                            ...
                            <form class="validate-form mt-2 pt-50" method="POST" action="{{route('client.profile')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        ...
                                        <input type="text" class="form-control account-number-mask" id="phone"
