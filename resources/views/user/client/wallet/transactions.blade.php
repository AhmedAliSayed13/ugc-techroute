                    ...
                    <div class="col-12 ">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div>
                                    <h2 class="fw-bolder mb-0 fw-bolder text-primary">$ {{Auth::user()->wallet(2)->balance}}
                                    </h2>
                                    <p class="card-text">{{__('messages.wallet_balance')}}</p>
                                </div>
                                <div class="  p-50 m-0">

                                    <a type="button" href="{{route('client.wallet.topup')}}" class="btn btn-relief-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td>{{isset($transaction->task)?$transaction->task->getTaskKey():'-'}}
                                                </td>
                                                <td>{{isset($transaction->order)?$transaction->order->product_name:'-'}}
                                                </td> --}}
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="text-warning">{{$transaction->transactionStatus->name}}</span>
                                                    @elseif($transaction->transaction_status_id == 2)
                                                    <span
                                                        class="text-success">{{$transaction->transactionStatus->name}}</span>
                                                    @elseif($transaction->transaction_status_id == 3)
                                                    <span
                                                        class="text-danger">{{$transaction->transactionStatus->name}}</span>
                                                    @endif
                                                </td>
                                    ...
                                    <p class="card-text text-center">{{
                                        $data['transactions']->links('pagination::bootstrap-4') }}
                                    </p>
                                </div>
                            </div>
                        </div>
