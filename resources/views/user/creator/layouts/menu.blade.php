        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="dropdown nav-item {{checkActiveRoute('creator.profile')}}" >
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.profile')}}" ><i data-feather="home">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item d-flex align-items-center dropdown-toggle" href="#" data-bs-toggle="dropdown" data-i18n="Page Layouts"><i data-feather="layout"></i><span data-i18n="Page Layouts">Page Layouts</span></a>
                            <ul class="dropdown-menu" data-bs-popper="none">
                                ...
                                <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="layout-empty.html" data-bs-toggle="" data-i18n="Layout Empty"><i data-feather="circle"></i><span data-i18n="Layout Empty">Layout Empty</span></a>
                                </li>
