        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="dropdown nav-item {{checkActiveRoute('creator.dashboard')}}">
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.dashboard')}}"><i
                            data-feather="home">
                        </i><span data-i18n="Dashboards">{{__('messages.Dashboards')}}</span></a>
                </li>
                <li class="dropdown nav-item {{checkActiveRoute('creator.profile')}}">
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.profile')}}"><i
                            data-feather="home">
                        </i><span data-i18n="Dashboards">{{__('messages.myAccount')}}</span></a>
                </li>
                <li class="dropdown nav-item {{checkActiveRoute('creator.offers.index')}}">
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.offers.index')}}"><i
                            data-feather="home">
                        </i><span data-i18n="Dashboards">{{__('messages.offers')}}</span></a>
                </li>
                <li class="dropdown nav-item {{checkActiveRoute('creator.tasks.index')}}">
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.tasks.index')}}"><i
                            data-feather="home">
                        </i><span data-i18n="Dashboards">{{__('messages.tasks')}}</span></a>
                </li>
                <li class="dropdown nav-item {{checkActiveRoute('creator.shippings')}}">
                    <a class=" nav-link d-flex align-items-center" href="{{route('creator.shippings')}}"><i
                            data-feather="gift">
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        ...
                        <li class="disabled" data-menu=""><a class="dropdown-item d-flex align-items-center" href=""
                                data-bs-toggle="" data-i18n="Disabled Menu"><i data-feather="eye-off"></i><span
