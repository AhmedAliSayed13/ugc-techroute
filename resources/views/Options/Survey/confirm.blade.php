                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Success !</h3>
                                    <p class="text-muted font-14 mt-2"> Thank you for completing the survey! Your feedback is valuable to us. </p>
                                    @if($survey->answer==0 && $survey->reason==null)
                                        <form method="POST" action="{{route('survey.reason')}}" >
                                            @csrf
                                            <input type="hidden" name="key" value="{{$survey->key}}">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="reason" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
