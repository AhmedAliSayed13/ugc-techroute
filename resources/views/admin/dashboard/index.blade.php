            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$data['AdsToday']}}</span>
                                </h3>
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span
                                        data-plugin="counterup">{{$data['MarketingServiceTypes']}}</span></h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$data['Customers']}}</span>
                                </h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$data['Emirate']}}</span>
                                </h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$data['Contracts']}}</span>
                                </h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span
                                        data-plugin="counterup">{{$data['ContractTypes']}}</span></h3>
