<nav class="navbar sticky-lg-top navbar-expand-lg navbar-light bg-white border-bottom">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
            <img src="{{asset('users-asset/images/logo/logo.png')}}" alt="logo" class="vidoo_logo img-fluid" height="50"
                width="100">
        </a>
        <button class="navbar-toggler" type="button" onclick="toggleNav()" data-bs-toggle="collapse"
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link {{checkActiveRoute('success')}} " aria-current="page"
                        href="{{route('success')}}">{{__('website.success')}}</a>
                </li>
            ...
            <div class="d-md-flex align-items-center">
                ...
                <a type="button" href="{{route('creator.register')}}" class="btn log-in-button my-md-0 my-2"
                    type="submit"> ابدأ الان</a>
            </div>
        </div>
    </div>
</nav>
